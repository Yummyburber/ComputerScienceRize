...
>>>>>>> 5713e9b5ed631cf09427f6232eee7722483e1cef
...
## 3. What does the "Checkout code" step do and why is it necessary?
It is necessary because that's how you  get the code from the repo for github actions to work. gets files from the website! it also prepares for deployment
...
## 6. What would happen if you pushed code to a different branch (not main)?
so workflow runs a pull request, the site doesn't change until you push to main. it only deploys when the event is a push to "main".
>>>>>>> 5713e9b5ed631cf09427f6232eee7722483e1cef
